...
In recent years, researchers have become increasingly interested in levering behavioral economics insights with AI chatbots to alleviate the complexities in a student's transition from high school to college (CITE). These studies have found somewhat positive effects of using chatbots deployed within a specific university context on pre-matriculation tasks and seamless college enrollment (CITE). However, there is no evidence of the scalability of these kinds of interventions when a chatbot is used 1) outside a university and 2) targeting a large population of students transitioning to college.
...
Despite increasing access to higher education in recent decades, there are still disparities in college attainment by socioeconomic status and parental education (CITE). For example, students whose parents received a college degree enroll in college at higher rates than those parents who did not complete high school (CITE). Additionally, students from wealthier backgrounds are more likely to enroll and complete postsecondary education than students from less-resourced families (CITE). For example, around 13% of students from the lowest income brackets earn a bachelor's degree by age 24, compared to 64% of students from the highest income brackets (CITE). Disparities in college access and completion -- along with social and structural barriers -- exacerbate the growing income inequality in the US (Calahar et al., 2021; Dynarski).
...
Considerable research attention has been paid to the roadblocks that first-generation low-income students often face in accessing postsecondary education (CITE). To sucessfully enroll in college, students must complete a series of administrative steps ritled with complexities. For example, these include sucesfully submiting college applicaitons, applying for various forms of financial aid, and weighting various adminisosns offers and financial aid awards. However, even after a student accepts a admissions offer they must complete a series of pre-matriculation task such as submitting high school transcripts to their college. If a student falters at any of these steps students may ultimately fail to matriculate into college.

A large of portion of admitted college students fail to matriculate, through a process theremed "summer melt." Summer melt describes the process by which college-intentind high school graduates fail to enroll in the fall semester due to challenged in navigating pre-matriculation tasks (CITE). Castleman & Page have found that summer rate affect an estimated 10 to 20 percent of college intentind high school students, with higher rates for low-income, first-generation students. These pre matriculationg task are not incosequencital, faltering at any step can mean losing access to grant dollars or having an offer revoked. These include studnets evalutiating their financial aid letters, filing administrative paperwork, making housing arangement, and completing placement test. Most concering, is that summer melt disproportionately affects students who are low-income and first generations and may not have access to the informations hleping navigate these complex adminsitrative tasks.

For fist-generation and low-income students their is an added complexitie of having to complete these task with little to no prior knowledge of navigating this process, compared to continuing education students.  

Moreover, non-financial barriers include a lack of access to social and cultural capital to navigate the higher education system (Bourdieu, 1973; Perna, 2006). Researchers have noted that first-generation students face a "cultural clash" when navigating into and through college as they must learn the complex process of enrolling and succeeding in college (CITE), such as developing a college list, successfully submitting an application, and completing pre-matriculation tasks.
