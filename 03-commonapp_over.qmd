...
However, questions remain about the scalability of these AI chatbot interventions. Prior research has highlighted that similar nudge interventions -- not using chatbots -- fail to maintain efficacy when scaled to a national level and target hundreds of thousands of students (CITE). Therefore, my second dissertation study aims to add to the literature on the scalability of AI chatbot campaigns.
...
In a series of studies, Page and colleagues (CITE) have shown how supporting students in submitting the FAFSA has led to positive college enrollment outcomes. For example, Page and colleagues (2020) conducted a randomized trial that provided students with timely, personalized reminders about the importance of the FAFSA in the summer before college. They find that this support improved students' successful completion of the FAFSA (CITE). However, even after a student completes the FAFSA, a portion of FAFSA fillers -- a majority who are low-income -- have their FAFSA form flagged for further scrutiny, which can ultimately delay the disbursement of aid(CITE). This verification process has been shown to lead to lower college matriculation rates, especially for first-generation low-income students (CITE). However, once a student accepts an admission offer, there remain additional barriers to enrollment.

Many scholars have argued that the summer between college enrollment is fraught with additional barriers to college matriculation (CITE). After accepting an admission offer, students must navigate the equally cumbersome college enrollment process. Students must complete a series of pre-matriculation administrative tasks, including submitting high school transcripts, deciding which and how much aid to accept, taking placement exams, and successfully enrolling in classes (CITE). If students do not complete any of these steps, they may eventually fail to enroll in college.

### Unique challenges in college access among first-generation students

However, for first-generation students, there is an added layer of complexity in navigating these tasks with little to no access to social and cultural capital around the college application process. For example, scholars have emphasized how first-generation students tend to reside in schools with less access to college prep or Advanced Placement (AP) courses, which have been positively associated with college enrollment (CITE). Additionally, first-generation students attend schools with little to no access to college counselors, which could support students complete college applications and navigating the complex financial aid process (CITE). However, even when students have access to a college counselor, these counselors are burdened with high caseloads and cannot provide individualized support to students (CITE).

In addition, first-generation students who are racially marginalized must endure social and systemic barriers and policies that traditionally left them with less access to high-quality primary and secondary education (CITE). For example, policies that funnel racially marginalized students into underserved schools, with limited access to college prep courses, and school tracking policies that exclude racially marginalized students from gaining access to the college prep tracks that would make them eligible to apply to college (Oakes, 2005; Oakes, Rogers, Lipton, & Morell, 2002; Solorzano & Ornelas, 2002, 2004). Additionally, due to decades of systemic oppression, these students have less access to intergenerational wealth, which could finance college. Therefore, they must rely on financial aid to fund their postsecondary education (CITE). However, substantial interventions have focused on supporting these students in completing their pre-matriculation tasks by providing access to college advising (CITE).

### College advising as a tool to increase college access

A rich body of literature has evaluated the effectiveness of behavioral interventions that examine ways to support students in the key steps and deadlines to enroll in college. One favored approach to remedying students' information asymmetries in the college-going process is access to high-quality college advising that can support students' transition to college. 

The literature points to the positive effects of access to college advising, resulting in higher college matriculation rates and persistence (CITE). For example, Castleman et al. (2012) conducted a randomized experiment in which college counseling was offered to low-income students during the summer before college. This intervention resulted in an increase in student immediate college enrollment by 14 percentage points. Although this study occurred within relatively diverse schools, these schools were "choice" schools and therefore these results may not generalize to public schools.

However, a follow-up study by Castleman, Page and Schooley (2014) looked at two interventions with a more nationally representative sample of public schools in Boston and Fulton County, Georgia. Researchers found similar effects to the previous study by Castleman et al. (2012). Students who received proactive college advising in the summer before college had an increase in college enrollment, from 8 to 12 percentage points among low-income students. Additional studies have shown the positive effects of providing first-generation students with quality college counseling (CITE). However, in the backdrop of a global pandemic, access to college advising was heavily impacted. 

Naughton (2021) describes the challenges in college advising during the pandemic as turning preexisting "cracks" in the ability to provide students advising services into "craters." This is primarily driven by the pivot of high schools from in-person to virtual advising. Naughton finds that college advisors felt ineffective in providing virtual support and guidance once high schools transitioned to virtual advising. The ability of the advisors to contact students was severely diminished and left students without support to facilitate their college transition (CITE). Naughton explains that advisers in high schools with higher college enrollment rates were far less impacted than students with lower college enrollment rates, precisely the ones that needed the most support (CITE). Therefore, approaches that bring college advising directly to students who need it most are crucial.

### Behavioral nudge interventions

A low-cost way to provide students with college counseling support has been behavioral nudge interventions. These interventions distill complex information and deadlines into short, concise messaging delivered to students via a mode of communication that students are well aware of -- text messages. In the context of college access, these studies have primarily focused on helping students navigate well-defined but complex tasks such as completing financial aid applications, submitting high school transcripts, and enrolling in classes. Without access to support during the summer before college, students may ultimately fail to enroll.

Several randomized trials in higher education have evaluated the use of nudge interventions to support students during the summer before college to mitigate what Castleman & Page coined as "summer melt"(CITE). Summer melt describes the process by which college-intending high school graduates fail to enroll in the fall semester due to challenges in navigating the array of pre-matriculating tasks (CITE). Students may fail to enroll because of minimal information and guidance in navigating pre-matriculation tasks. These include missing critical deadlines for financial aid or not submitting transcripts or other documents. Castleman & Page (YEAR; YEAR) have found that summer melt affects an estimated 10 to 20 percent of college-intending high school students. The concern is that summer melt disproportionately affects low-income and first-generation students and students of color, who may not have access to the information to help navigate these complex administrative tasks (CITE).

Castleman and Page have conducted several large randomized controlled studies to support college-intending high school students with completing their FAFSA and enrolling in college. For example, Castleman and Page (2015) employ an automated and personalized text message campaign to "nudge" students on pre-matriculation tasks. They found that the text message campaign increased enrollment among students with less access to college access support, to the tune of approximately 7 percentage points increase in college enrollment compared to the control group. The authors also noted the low relative cost of the intervention at about $7 per student. The low-cost nature of these nudge interventions has also been cited in previous literature and has spurred interest in nudges in the last 10 years. However, in contrast to another intervention area in Boston, MA, the researchers find no effects. They reason that this is likely due to schools in that area already having many school-year and summer supports available to students. This study, along with others, has consistently shown that these interventions are most effective when nudges are delivered to students with less access to college support (CITE). However, the evidence on the scalability of these interventions is mixed.

However, in recent years researchers have explored the scalability of behavioral nudge interventions to a broader context, given most large college access studies to date were campaigns partnering with local high schoolls, colleges, or non-profits (CITE). A recent study examined nudges -- coming from multiple modalities including email and text message -- encouring students to copmlete their FAFSA and enroll in college. What made this study unique was that it targeted nearly 800,000 students across the country who usec the Common Application or the Texas applicaiton portal to apply to college. Researchers foudn that none of intervntion arms increases financial aid receipt, college, enrollment or persistance. The authors conclude that scaling nudge campaigns can be challening when bieng implemented by a large organization since student may not have a strong connection to a large organization like the Common App as opposed to their local high school. Additionally, in order to deliver nudges to a broad group of students the messages may appear "generic and one-way" and may not be personlized enough to actually nudge students to actionnable steps. However, recent studies have used technological advances to aid in scale nudge interventions with more personalized messsaging. 

### AI Chat-bots in college access

A recent push in the behavioral nudge literature has been to levelrea artifial intelligence (AI) chatbots to provide personalized support to students navigating college applicaiton and enrollment. These AI conversational chatbots are able to provide personalized information to students around deadlines, and specific college-going quesitons. These AI bots are trained by human superision to provide suport to students. Overtime the AI "learns" how to handle increasinlgy complex questions from students. Once sucessfull trained and deployed to student the AI can help student andwer quesitons around important deadlines to when they should submit their transcripts. 

A series of recent studies conducted by Page, Gelhbach and collegeues have exmployed AI chatbots to help student enroll and navigate college (CITE). In the first study to use AI chatbots in higher educaiton 
studdy Page and Gelbach (2017) used in AI chatbot named "Pounce" located in Georgia Stata Universtiy (GSU) helped freshmanstudents who were accpeted to join GSU in fall 2017 with on time matricutiona and pre-matriculation task at GSU. The use of the chatbot lead to a 3.3 percentage point increase in timenly enrollment at GSU as well as well as hlped students with pre-matriculation class like signing up for orientation. 

In a follow up study by Page and colleges (20202) shifted the focus of the study from helping students enroll at GSU main and perimeter campus to helpoing students navigate the administrative process after student arrive at GSU and persist using campus based reserouces. This study also extended instituional to also include both two (Perimete College campusse(GSU-Atlanta) and four-year college campus. 

Through a RCT Page and colelges foudn taht outreach was most effective when the chatbot was focused on adminsitrative process, particualry those that were time sensityve. However, when oureach that focused on suplmente academic, social and carrerl-related suport, such as meeting with an advisor was not found to be effective. The authors conclude that the AI-bot outreach was most effective and changing student bahvior when the bot was focused on discrete, well-defined administion tasks in which a lack of action lead to high consequences, such as resolving registration holds. However, when the chatbot support did not efect student utilizing supolemtne supports such as meeting with advisre. These restuls are in line with prefious research, were students were less eresponsive to nudges related to less-time sensitive task such as furture job prospects (CITE). Its important to note that the aferemnetioned studies occured within the Gerogia State Univeristy system therefore an open question was wether thes AI chatbot intervention replicate to other instions. 

In sum, the use of AI chatbots parralel the effects found in regular text-message nudges where context matters and the obstensie send matters. When messages are focused at small discrte, time0sensitive task students are more responsive to change than when targeting wider outcomes. 

In response to this open questions Nushatayeva and collegesfurther replicate the work of Page and gelbach 2017 by testing if AI chatbots are effective at a different four-year instiions. This study took place at EAst Carolina Univesicy ECU with an AI chatbot names PeeDee. 
The authors found no overall effect of the chatbot on college enrollment, but did find an effect on loan acceptance rates. The authors point to realtive advanataged student body and ECU to explain their null effect on college enrollmentcompared to overall positive effect on college enrollment found in the GSU study. 
However, authors did find a postive treatment effects for first-generation students. PeeDee did not increase enrollemnt at ECU however they didn fin an increase lead to an increace of enrolling at ECU by 3 percentage points for first-generation students, and an increase of completing pre-matriculation task such as accpeintg a loan (8 percentage point incres), and registerign fro class (3 percentage point increase).

In sum the current literature on the use of AI chatbots in postsecondary educaiton parallels the overall restuls of the mature litearture on general nudges in college accee -- context matters. AI chatbot nudges are not university effective. The literature points to these interventions being most salient when chatbots are used to help nudge students on time-sensitive, actionable task for students like submitting documnets. In regards to enrollment, these chatbots seems to be most effective in helpin first-generaiton students enroll in college. 
...
However, it is important to note that all three of these studies occured within a local univeristy or across a subset of a univeristy system in the case of the (CITE). 
