# Paper 2: Navigating college enrollment during COVID-19: examining the effectiveness of an artificially intelligent chatbot in helping students navigate the road to college
...
Postition the literature

General statement...this is what most scholar generally...

In addition,Page
In contarast to these view, other researchers hypothesize
For example
Page...however,

Therefore, draw a conclusion

Pointing words: This (pointer)
Transitions:
In contrast to...Other authors claim

Reader is not bright!

The literature on ..is not as decisive as these theories would suggest...

The theorretical literature does not ....

Empirical evidens on .. is limited..is meager

Therefore, the goal of my first dissers to focus on .... an often forgotten componer of research studies in AI chatbots

Topic sentence: Dogs make signitice contribution to humanity
Alternatively...transition words
...
### College access among first-generation students

Despite increasing access to higher education in recent decades, there remain disparities in college attainment by socioeconomic status and parental education (CITE). Students whose parents received a college degree enroll in college at higher rates than those parents who did not complete high school (CITE). Additionally, students from higher-income backgrounds are more likely to enroll and complete postsecondary education than students from less-resourced families (CITE). For example, around 13% of students from the lowest income brackets earn a bachelor's degree by age 24, compared to 64% of students from the highest income brackets (CITE). Yet, much of the quantitative literature fails to acknowledge systemic barriers and US policies' role in creating these disparities by excluding lower-income -- particularly people of color -- from accessing quality education, housing, and working conditions (CITE). Therefore, disparities in college access and completion by parental education -- along with social and structural barriers -- are vital contributors to the growing income inequality in the US.

However, even with the rising cost of college (CITE), the long-term economic returns to a college education and non-pecuniary benefits remain positive. Adults who earn a bachelor's degree tend to earn more and accumulate more wealth than those who have not completed college (CITE). However, researchers note that the rate of return is substantially higher for students from higher-income families as opposed to students from lower resources families (CITE). Additionally, on average, individuals with a college degree have lower unemployment rates, higher rates of civic involvement, and overall better healthcare outcomes (CITE). Therefore, the substantial policy focus on supporting college-intending first-generation students through the complex college-going process is warranted.

### Challenges in college access among first-generation students

However, access to postsecondary education is ridled with roadblocks, expecially during college application process. Considerable research attention has been paid to complexities that first-generation students -- many of whom are also economically and racially marginalized -- face in the college application process (CITE). Students must first begin by navigating a complex college application process where by, students must complete complex administrative steps such as succesfully submitting college applicaitons, applying for various forms of financial aid, and weightin competing admissions offers (CITE). 

For example, many first-generation students come from families with lower family incomes and may need financial support to finances their postsecondary aspirations. Therefore, these students must naviatage a complex financial aid process which requires students to complete a nearly XX question form asking about familial accets in order to get access to federal, state, and grant aid. Even when students sucefully complete the FAFSA they face additional challenges by which a percentage of students -- many of whom are first-generation and low-income -- get flagged for additionla verification which may delay their aid (CITE). 




After a students accepts an offer students must then navigate the equally complex college enrollment process, where by they must complete a series of pre-matriculation task such as submitting high school transcripts to their college. 





Additionally, before students enroll in a college students must complete a series of pre-matriculation task which include submitting high school transcripts, deciding which and how much aid to accept, and sucesfully enroll in classes (CITE). For fist-generation and low-income students their is an added complexitie of having to complete these task with little to no prior knowledge of navigating this process, compared to continuing education students. If a student falters at any of these steps students may ultimately fail to matriculate into college.
...
Succesfully enrolling in college is far more complex for first-generation students that students whos parents have prior knowledge of navigating the college transition process. Given that first-generation students must navigate the college-going process with a lack of access to social and cultural capital around college-going, which could support students in navigating the complex college access process. For instance, first-generation students tend to reside in schools with less access to college prep of Advanced Placement (AP) course, which have been shown to be poistively associated with college enrollment. In addition, first-generation students tend to attend schools with little to no college counselors which could could support students in completing college applicaitons and navigating the complex financial aid process (CITE).
...
The pandemics effects disproporitionatley affected first-generation students -- many of whom are racially and economically marginalized.For wexmaple for these gropus access to mentlah heatl services was severely limited, as well as high quality healthcare (CITE). Additionaly, Students from higher incomes were far more liley to enroll in college imediately after high school gradution (65%) compared to students from low-income high schools (49%). First generation faced addtional hardships, such as increased financial hardships. First-generation students were nearly twice as likely to beconcerned about paying for education expenses in fall 2020 than non-first-generation students. They also were less likely to report living in a safe environment and more likely to experience food and housing insecurity.
