...
I used a Monte Carlo simulation to compare the performance of various propensity score estimation techniques against the traditional logistic regression and my proposed DNN-based approach using high-dimensional data. I assess the performance by how well each method captures an artificial treatment effect and balances observed covariates. Specifically, I evaluate the performance of popular machine learning algorithms used in the propensity score estimation literature, including classification and regression tree (CART), bagged CART, random forest, and a single-layer neural network.
